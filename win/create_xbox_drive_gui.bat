...
::  2019/11/01 - create_xbox_drive_gui.bat calls create_xbox_drive_gui.ps1 (9.0) - XFiX
::
::  Credit History:
...
echo.
echo * Running: create_xbox_drive_gui.ps1
...
cd /D %~dp0
powershell -ExecutionPolicy ByPass -File create_xbox_drive_gui.ps1
